...
const dbData = {
    ...
    lecturers: [
        { id: 1, name: "PGS.TS Nguyễn Văn Chung", title: "Trưởng khoa CNTT", department: "Khoa Công nghệ thông tin", expertise: "Trí tuệ nhân tạo, Machine Learning", avatar: "https://ui-avatars.com/api/?name=Nguyen+Van+A&background=2C3E50&color=fff&size=100", email: "nguyenvana@dainam.edu.vn", years: "20 năm kinh nghiệm" },
        { id: 2, name: "TS. Trần Thị Trang", title: "Phó Trưởng khoa CNTT", department: "Khoa Công nghệ thông tin", expertise: "Cơ sở dữ liệu, Hệ quản trị CSDL", avatar: "https://ui-avatars.com/api/?name=Tran+Thi+B&background=E74C3C&color=fff&size=100", email: "tranthib@dainam.edu.vn", years: "15 năm kinh nghiệm" },
        { id: 3, name: "ThS. Lê Văn Chi", title: "Giảng viên chính", department: "Khoa Công nghệ thông tin", expertise: "Lập trình C++, C#, .NET", avatar: "https://ui-avatars.com/api/?name=Le+Van+C&background=2980B9&color=fff&size=100", email: "levanc@dainam.edu.vn", years: "12 năm kinh nghiệm" },
        { id: 4, name: "ThS. Phạm Thị Dạ", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Mạng máy tính, An ninh mạng", avatar: "https://ui-avatars.com/api/?name=Pham+Thi+D&background=27AE60&color=fff&size=100", email: "phamthid@dainam.edu.vn", years: "10 năm kinh nghiệm" },
        { id: 5, name: "ThS. Hoàng Văn Yến", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Toán rời rạc, Giải tích số", avatar: "https://ui-avatars.com/api/?name=Hoang+Van+E&background=8E44AD&color=fff&size=100", email: "hoangvane@dainam.edu.vn", years: "8 năm kinh nghiệm" },
        { id: 6, name: "TS. Nguyễn Thị Đào", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Trí tuệ nhân tạo, Xử lý ngôn ngữ tự nhiên", avatar: "https://ui-avatars.com/api/?name=Nguyen+Thi+F&background=D35400&color=fff&size=100", email: "nguyenthif@dainam.edu.vn", years: "9 năm kinh nghiệm" },
        { id: 7, name: "ThS. Trịnh Văn Giỏi", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Phát triển phần mềm, Agile, Scrum", avatar: "https://ui-avatars.com/api/?name=Trinh+Van+G&background=1ABC9C&color=fff&size=100", email: "trinhvang@dainam.edu.vn", years: "7 năm kinh nghiệm" },
        { id: 8, name: "ThS. Bùi Thị Hà", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Thiết kế Web, UI/UX, JavaScript", avatar: "https://ui-avatars.com/api/?name=Bui+Thi+H&background=3498DB&color=fff&size=100", email: "buithih@dainam.edu.vn", years: "6 năm kinh nghiệm" },
        { id: 9, name: "TS. Đặng Văn Tuyến", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Học máy, Deep Learning, Python", avatar: "https://ui-avatars.com/api/?name=Dang+Van+I&background=E67E22&color=fff&size=100", email: "dangvani@dainam.edu.vn", years: "11 năm kinh nghiệm" },
        { id: 10, name: "ThS. Vũ Thị Khương", title: "Giảng viên", department: "Khoa Công nghệ thông tin", expertise: "Cơ sở dữ liệu, NoSQL, Big Data", avatar: "https://ui-avatars.com/api/?name=Vu+Thi+K&background=9B59B6&color=fff&size=100", email: "vuthik@dainam.edu.vn", years: "8 năm kinh nghiệm" }
    ]
};
